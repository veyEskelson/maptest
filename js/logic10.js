...
var AustinAnimals = new L.LayerGroup();
...
d3.json(urloffleash, function(data){
  ...
  urlAnimals ="https://raw.githubusercontent.com/ziangzhang10/data_bootcamp_project2/master/Resources/fulldata.json";

d3.json(urlAnimals, function(data){
    console.log(typeof(data));
    L.geoJson(data, {
      // Style each feature (in this case a region)
      style: function(feature) {
